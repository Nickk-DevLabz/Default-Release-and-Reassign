...
# ==============================================================================
# STAGE 3: GUI CONSTRUCTION (THE LIBRARIES)
# ==============================================================================

$Categories = [ordered]@{
    "All"          = @()
    "Web/URL"      = @(".html",".htm",".url",".php",".webp",".css",".js",".asp",".aspx","http","https","mailto")
    "Photos/Image" = @(".jpg",".jpeg",".png",".gif",".bmp",".tiff",".ico",".svg",".heic",".raw",".psd",".ai")
...
$BtnAssign.Add_Click({
    ...
    foreach($row in $selectedRows) {
        $ext = $row.Cells["Ext"].Value
        Set-Status "Waiting for User: $ext"
