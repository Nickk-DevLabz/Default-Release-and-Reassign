...
function Refresh-RegistryData {
    ...
    try {
        ...
        # Build "Unassigned" Category dynamically
...
# ==============================================================================
# STAGE 3: GUI CONSTRUCTION (LIBRARIES)
# ==============================================================================
...
$Form.Text = "WinClean Pro v7.9 - Association Architect"; $Form.Size = "850, 750"; $Form.StartPosition = "CenterScreen"
...
$ToolsTab.Controls.AddRange(@($LblBackupPath, $BtnSetPath, $BtnRestorePoint, $BtnCleanTemp))
...
$BtnSetPath.Add_Click({
    ...
    if ($FolderBrowser.ShowDialog() -eq "OK") {
        ...
        Write-Log "Backup path set: $DefaultBackupPath"
    }
})
...
$BtnCleanTemp.Add_Click({
    ...
    Write-Log "Cleaned $count picker files from $env:TEMP"
})

$BtnRelease.Add_Click({
    Set-Status "Backing up & Releasing..." "Orange"
